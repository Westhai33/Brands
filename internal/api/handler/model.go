...
// SearchModels godoc
// @Summary Поиск моделей по фильтру
// @Description Поиск моделей с фильтрацией и сортировкой
// @Tags models
// @Accept json
// @Produce json
// @Param filter query string false "Фильтрация по полю"
...
// @Param order query string false "Порядок сортировки (asc, desc)"
// @Success 200 {array} dto.Model "Список моделей"
// @Failure 500 {string} string "Failed to search models"
// @Router /models/search [get]
func (api *ModelHandler) SearchModels(ctx *fasthttp.RequestCtx) {
