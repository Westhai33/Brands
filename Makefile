...
reset:
	...
	goose -dir ./migrations postgres "host=localhost port=5432 user=brands password=pgpwdbrands dbname=brands sslmode=disable" reset
	@echo "Database migrations reset successfully."

# Таргет для отката миграций базы данных
down:
	@echo "Rolling back the last migration..."
	goose -dir ./migrations postgres "host=localhost port=5432 user=brands password=pgpwdbrands dbname=brands sslmode=disable" down
...
db-shell:
	...
	docker exec -it itemCloudBrandsPostgres psql -U brands -d brands
